...
<div class="container">	
	...
	<form name="myform" method="post" action="${ctp}/BoardUpdateOk.bo">
		<table class="table table-bordered">
			...
			<tr>
				<th>내용</th>
				<td><textarea rows="6" name="content" required class="form-control">${vo.content}</textarea></td>
			</tr>		
			<tr>
				<th>공개 여부</th>
				<td>
			...
			<tr>
				<td colspan="2" class="text-center">
					<input type="button" value="글 수정" onclick="fCheck()" class="btn btn-success mr-3"/>
