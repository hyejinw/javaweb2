...
<div class="container text-center">	
	...
	<div class="row">
		...
		<div class="col-xl-2"><button type="button" onclick="searchCheck()" class="btn btn-primary">개별조회</button></div>
		<div class="col-xl-2"><a href="${ctp}/database/List" class="btn btn-warning">전체조회</a></div>
		<div class="col-xl-2"><a href="${ctp}/database/Logout" class="btn btn-danger">로그아웃</a></div>
		<div class="col-xl-3"></div>
	</div>
	<hr/>
	<div id="demo"></div>
