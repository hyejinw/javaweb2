...
<div class="container">	
	<form name="myform" method="post" action="${ctp}/database/LoginOk">
		<table class="table table-bordered text-center">
			...
			<tr>
				<td colspan="2">
					<input type="button" value="비밀번호 찾기" onclick="location.href='finder.jsp';" class="btn btn-secondary mr-4"/>
					<input type="button" value="회원 가입" onclick="location.href='join.jsp';" class="btn btn-primary"/>
				</td>
			</tr>
		</table>
	</form>
