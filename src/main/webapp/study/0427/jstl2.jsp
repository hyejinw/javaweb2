...
<%
  String hobbies = "등산/낚시/수영/바둑/영화감상/음악감상";
...
%>
  ...
  <hr/>
  <p>문제1: 전송된 취미 중에서 '바둑'은 빨강색, '수영'은 파랑색, 나머지는 그대로 출력하시오.<br/>
		<c:forTokens var="hobby" items="${hobbies}" delims="/">
			<c:choose>
