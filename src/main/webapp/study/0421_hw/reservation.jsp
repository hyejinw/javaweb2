	...
	<div  style="padding:100px 0px">
	  ...
	  <div  style="margin:10px 220px">
		  <div class="card-deck"  style="width:700px">
		    <div class="card">
		    	 <img class="card-img-top" src="reservation1.png" alt="Card image" style="width:100%" class="text-center">
		    ...
		    <div class="card">
		    	 <img class="card-impaddingg-top" src="reservation2.png" alt="Card image" style="width:100%">
		       <div class="card-body text-center">
